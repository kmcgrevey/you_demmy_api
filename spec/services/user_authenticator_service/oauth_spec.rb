...
RSpec.describe UserAuthenticatorService::Oauth, type: :service do
  describe "#perform" do
    ...
    context "when code is incorrect" do
      ...
      it "should raise an error" do
        expect{ subject }.to raise_error(
          UserAuthenticatorService::Oauth::AuthenticationError
        )
    ...
    context "when code is correct" do
      ...
      it "should reuse existing registered user" do
